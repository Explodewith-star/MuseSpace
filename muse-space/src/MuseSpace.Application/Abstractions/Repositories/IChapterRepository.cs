...
public interface IChapterRepository
{
    ...
    Task<List<Chapter>> GetByOutlineAsync(Guid projectId, Guid outlineId, CancellationToken cancellationToken = default);
    ...
    /// <summary>删除由指定大纲建议导入且属于指定大纲的所有章节。</summary>
    Task<int> DeleteBySourceSuggestionIdAsync(Guid suggestionId, Guid storyOutlineId, CancellationToken cancellationToken = default);
